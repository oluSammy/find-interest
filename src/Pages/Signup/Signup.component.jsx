                    ...
                    <Grid container className={classes.gridContainer} alignItems="center">
                            ...
                            <Grid item xs={12} sm={6} md={6}>
                                <form className={classes.signupBox}>
                                    ...
                                    <Button className={clsx(classes.formInput, classes.signupBtn)} startIcon={<BiLogIn />} variant="contained" color="primary">SIGN UP</Button>
                                    <Typography className={classes.already}>Already have an account? <span>Login</span> </Typography>
                                    <Button className={clsx(classes.formInput, classes.signupBtn)} variant="outlined" startIcon={<FcGoogle />}>Signup with Google</Button>
                                    </div>
                                </form>
                            </Grid>
                    </Grid>
